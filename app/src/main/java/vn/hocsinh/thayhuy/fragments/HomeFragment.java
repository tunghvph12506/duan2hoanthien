package vn.hocsinh.thayhuy.fragments;
...
import vn.hocsinh.thayhuy.activity.HighScoreActivity;
import vn.hocsinh.thayhuy.activity.PlayerActivity;
import vn.hocsinh.thayhuy.activity.SettingsActivity;
import vn.hocsinh.thayhuy.dialogs.AboutDialog;
...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> App.getMusicPlayer().playBgMusic(R.raw.bgmusic), 2500);
    }
